...
import fr.friquerette.gradlews.rt.api.Foursquare2Api;
import fr.friquerette.gradlews.rt.model.OAuthRequest;
import fr.friquerette.gradlews.rt.model.Response;
import fr.friquerette.gradlews.rt.model.Token;
import fr.friquerette.gradlews.rt.model.Verb;
import fr.friquerette.gradlews.rt.model.Verifier;
import fr.friquerette.gradlews.rt.service.OAuthService;
import fr.friquerette.gradlews.rt.service.ServiceBuilder;
...
public class Foursquare2Example {
	...
	public static void main(String[] args) {
		...
		OAuthService service = new ServiceBuilder().provider(Foursquare2Api.class).apiKey(apiKey).apiSecret(apiSecret)
